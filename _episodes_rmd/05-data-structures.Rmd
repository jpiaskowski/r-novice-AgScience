...
But, first we need to learn how to load data. One of R's most powerful features is its ability to deal with tabular data -
...
Okay, let's read some data in! First,we load a data set of plant growth under different CO2 regimes

```{r}
pig_feed <- read.csv("data/pig_feeding.csv")
```

We can see there are 50 rows of 5 variables. By clicking on the small arrow next to the object name, more information about the variables can be seen. 
...
This is sometimes called a "slice". 
