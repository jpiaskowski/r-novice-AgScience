...
### *Brought to you by...STATISTICAL PROGRAMS!!*
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.cap="Statistical Consultants",fig.show='hold',fig.align='center'}
knitr::include_graphics(c("../fig/The_Incredible_Hulk.jpg", "../fig/captain_marvel_binary.jpg"))
```
